...
// ELSA AI (Rupee-Based Automation / Bill Intelligence / Load Health / Solution Routing)
import ElsaAI                 from './pages/user/ElsaAI'
import OrgElsaAI              from './pages/org/OrgElsaAI'
import EVChargerPage          from './pages/org/EVChargerPage'
  ...
  return (
    <Routes>
      ...
      <Route path="/org" element={
        ...
        <Route path="elsa-ai"           element={<OrgElsaAI />} />
        <Route path="custom-dashboard" element={<DashboardList />} />
        <Route path="custom-dashboard/:id" element={<DashboardEditor />} />
      ...
      <Route path="/user" element={
        ...
        <Route path="elsa-ai"            element={<ElsaAI />} />
        <Route path="custom-dashboard" element={<DashboardList />} />
        <Route path="custom-dashboard/:id" element={<DashboardEditor />} />
      </Route>
