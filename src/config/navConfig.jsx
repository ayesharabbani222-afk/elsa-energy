import {
  ...
  LayoutTemplate, ShieldCheck, Boxes, Sparkles,
  BatteryCharging, PlugZap, Repeat, ScrollText, Truck, UserCircle2, SlidersHorizontal,
} from 'lucide-react'
...
export const orgNav = [
  ...
  { to: '/org/elsa-ai',            label: 'ELSA AI',         icon: Sparkles },
  ...
  { divider: true, label: 'EV Charging' },
  {
    label: 'EV Charger',
    icon: BatteryCharging,
    children: [
      { to: '/org/ev-charger/live-session',    label: 'Live Session',    icon: PlugZap },
      { to: '/org/ev-charger/analytics',       label: 'Analytics',       icon: BarChart3 },
      { to: '/org/ev-charger/energy-hub',      label: 'Energy Hub',      icon: Zap },
      { to: '/org/ev-charger/v2g-exports',     label: 'V2G / Exports',   icon: Repeat },
      { to: '/org/ev-charger/ai-decision-log', label: 'AI Decision Log', icon: ScrollText },
      { to: '/org/ev-charger/fleet',           label: 'Fleet',           icon: Truck },
      { to: '/org/ev-charger/profile',         label: 'Profile',         icon: UserCircle2 },
      { to: '/org/ev-charger/control-system',  label: 'Control System',  icon: SlidersHorizontal },
    ],
  },
]
...
export const userNav = [
  ...
  { to: '/user/elsa-ai',           label: 'ELSA AI',            icon: Sparkles },
